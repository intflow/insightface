...
if __name__ == "__main__":
    ...
    parser.add_argument('--embeddings_path', default="/home/gbkim/gb_dev/insightface_MXNet/insightface/face_identification/model/keras_softmax_classifier/embeddings_info.pickle", help="path to the embedding info pickle file.")
    parser.add_argument('--encoded_label_path', default="/home/gbkim/gb_dev/insightface_MXNet/insightface/face_identification/model/keras_softmax_classifier/label.pickle", help="path to the embedding info pickle file.")
    parser.add_argument("--classifier_path", default="/home/gbkim/gb_dev/insightface_MXNet/insightface/face_identification/model/keras_softmax_classifier/embedding_classifier.h5")
