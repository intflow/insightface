...
def main(args, scale_candidate):
    ...
    # D_E_model = AnalyzeFace(args, scale_candidate)
    ...
    embedding_classifier = keras.models.load_model(args["classifier_path"])
    print("[INFO] embedding classifier model has been loaded...")
        ...
        if int(frames % args['frame_num_for_detection']) == 0:
            ...
            if not int(face_bbox.shape[0]) == 0:
                ...
                for i in range(face_bbox.shape[0]):
                    ...
                    candidate_index = np.argmax(preds)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--embeddings_path', default="/home/gbkim/gb_dev/insightface_MXNet/insightface/face_identification/face_bank/embeddings_info2.pickle", help="path to the embedding info pickle file.")
    parser.add_argument('--encoded_label_path', default="/home/gbkim/gb_dev/insightface_MXNet/insightface/face_identification/model/embedding_classifier/keras_softmax_classifier/label.pickle", help="path to the embedding info pickle file.")
    parser.add_argument("--classifier_path", default="/home/gbkim/gb_dev/insightface_MXNet/insightface/face_identification/model/embedding_classifier/keras_softmax_classifier/embedding_classifier.h5")
    ...
    ## Allocate a GPU device for inference
