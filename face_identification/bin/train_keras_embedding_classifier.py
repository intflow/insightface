...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_save_path', default="/home/gbkim/gb_dev/insightface_MXNet/insightface/face_identification/model/embedding_classifier/keras_softmax_classifier/embedding_classifier.h5", help="path of the model to be saved.")
    parser.add_argument('--encoded_label_save_path', default="/home/gbkim/gb_dev/insightface_MXNet/insightface/face_identification/model/embedding_classifier/keras_softmax_classifier/label.pickle", help="path of the label encoder to be saved.")
    ...
    parser.add_argument("--figure_save_path", default="/home/gbkim/gb_dev/insightface_MXNet/insightface/face_identification/model/embedding_classifier/keras_softmax_classifier/result_figure.png")
