...
if __name__ == "__main__":
    ...
    parser.add_argument('--encoded_label_path', default="/home/gbkim/gb_dev/insightface_MXNet/insightface/face_identification/face_bank/label.pickle", help="path to the embedding info pickle file.")
    parser.add_argument("--classifier_path", default="/home/gbkim/gb_dev/insightface_MXNet/insightface/face_identification/face_bank/embedding_classifier.h5")
